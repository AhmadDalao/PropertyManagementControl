...
class UserModuleArchitectureTest extends TestCase
{
    ...
    public function user_module_owns_each_resource_responsibility(): void
    {
        foreach ([
            ...
            $this->path('app/Http/Controllers/UserPortalAccessController.php'),
            $this->path('app/Modules/Users/Actions/CreateUser.php'),
            $this->path('app/Modules/Users/Actions/CreatePortalAccessLink.php'),
            ...
            $this->path('app/Modules/Users/Presenters/PortalAccessPresenter.php'),
            ...
            $this->path('resources/js/modules/users/portal-access-page.tsx'),
            $this->path('resources/js/modules/users/portal-access-generator.tsx'),
            $this->path('resources/js/modules/users/portal-access-account-card.tsx'),
            ...
            $this->path('resources/css/styles/users/portal-access.css'),
            $this->path('resources/css/styles/users/portal-access/layout.css'),
            $this->path('resources/css/styles/users/portal-access/generator.css'),
            $this->path('resources/css/styles/users/portal-access/responsive.css'),
        ] as $path) {
    ...
    public function user_facades_and_frontend_composers_stay_small(): void
    {
        foreach ([
            ...
            'app/Http/Controllers/UserPortalAccessController.php' => 45,
            'app/Modules/Users/Actions/CreatePortalAccessLink.php' => 60,
            'app/Modules/Users/Presenters/PortalAccessPresenter.php' => 75,
            ...
            'resources/js/modules/users/portal-access-page.tsx' => 60,
            'resources/js/modules/users/portal-access-generator.tsx' => 145,
