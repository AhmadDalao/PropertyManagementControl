...
use App\Http\Controllers\GlobalSearchPageController;
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/account-recovery', [ForgotPasswordController::class, 'create'])->name('password.request');
    Route::post('/account-recovery', [ForgotPasswordController::class, 'store'])->name('password.email');
...
Route::middleware(['auth', 'account.active', 'password.changed', 'property.context'])->group(function () {
    ...
    Route::get('/search', GlobalSearchPageController::class)->name('search.index');
    Route::get('/my-lease', [TenantPortalController::class, 'lease'])->name('tenant-portal.lease');
    Route::get('/my-payments', [TenantPortalController::class, 'payments'])->name('tenant-portal.payments');
    Route::get('/my-documents', [TenantPortalController::class, 'documents'])->name('tenant-portal.documents');
