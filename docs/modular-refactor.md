...
- Shared component, table, and workspace styling is now exposed through three thin facades over 18 bounded CSS layers. The production application stylesheet is 320.69 KB before gzip.
