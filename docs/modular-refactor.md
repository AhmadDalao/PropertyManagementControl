...
- Shared component, table, and workspace styling is now exposed through three thin facades over 17 bounded CSS layers. The original 1,904 rules preserve their cascade order and compile to the exact same 318.42 KB application bundle.
