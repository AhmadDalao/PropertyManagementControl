...
- Shared component, table, and workspace styling is now exposed through three thin facades over 18 bounded CSS layers. The production application stylesheet is 318.37 KB before gzip.
