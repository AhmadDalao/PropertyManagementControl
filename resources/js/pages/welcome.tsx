...
export default function Welcome() {
    return (
        <>
            <Head title="Welcome" />
            <div className="p-6 lg:justify-center lg:p-8 flex min-h-screen flex-col items-center bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a]">
                <div className="lg:grow flex w-full items-center justify-center opacity-100 transition-opacity duration-750 starting:opacity-0">
                    <main className="lg:max-w-4xl lg:flex-row flex w-full max-w-[335px] flex-col-reverse">
                        <div className="rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 lg:rounded-tl-lg lg:rounded-br-none lg:p-20 flex-1 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <ul className="mb-4 lg:mb-6 flex flex-col">
                                <li className="gap-4 py-2 before:bottom-0 relative flex items-center before:absolute before:top-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    <span className="bg-white py-1 relative dark:bg-[#161615]">
                                        <span className="h-3.5 w-3.5 flex items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                                    ...
                                    <span>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 space-x-1 font-medium inline-flex items-center text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                        >
                                ...
                                <li className="gap-4 py-2 before:top-0 relative flex items-center before:absolute before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    <span className="bg-white py-1 relative dark:bg-[#161615]">
                                        <span className="h-3.5 w-3.5 flex items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                        </span>
                            ...
                            <ul className="gap-3 text-sm leading-normal flex">
                                <li>
                                    <a
                                        href="https://cloud.laravel.com"
                                        target="_blank"
                                        className="rounded-sm border-black px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:hover:border-white dark:hover:bg-white inline-block border bg-[#1b1b18] dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A]"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="rounded-t-lg lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden bg-[#fff2f2] dark:bg-[#1D0002]">
                            {/* Laravel Logo */}
                            <svg
                                className="translate-y-0 motion-safe:starting:translate-y-6 w-full max-w-none text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            {/* 13 */}
                            <svg
                                className="-ml-8 lg:ml-0 relative -mt-[6.6rem] w-[438px] max-w-none [--stroke-color:#1B1B18] dark:[--stroke-color:#FF750F]"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="dark:text-black text-[#1B1B18] opacity-100 mix-blend-darken transition-all delay-300 duration-750 dark:mix-blend-normal starting:opacity-0">
                                    <mask
                                        id="path-1-mask"
                            ...
                            <div className="inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg absolute shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"></div>
                        </div>
                    </main>
                </div>
            </div>
