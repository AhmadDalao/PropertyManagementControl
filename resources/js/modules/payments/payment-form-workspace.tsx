...
import { PaymentFormGuide } from './payment-form-guide';
import { PaymentFormSection } from './payment-form-section';

export function PaymentFormWorkspace({
    page,
}: {
    ...
    return (
        <div className="pmc-payment-form-page">
            <ResourceHeader
                eyebrow={t('payments.payment_record')}
                title={page.title}
            ...
            />
            <section className="pmc-payment-form-layout">
                <form id={formId} onSubmit={submit}>
                    ...
                    <div className="pmc-payment-mobile-actions">
                ...
                <PaymentFormGuide fields={page.fields} values={form.data} />
            </section>
        </div>
    );
}
