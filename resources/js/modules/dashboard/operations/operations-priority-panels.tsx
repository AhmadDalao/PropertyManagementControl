...
export function OperationsPriorityPanels({
    ...
    return (
        <div className="pmc-command-grid">
            ...
            {active === 'move_outs' ? (
                <div
                    id="dashboard-work-panel-move_outs"
                    className={workPanelClass('move_outs', active)}
                    data-dashboard-work-panel="move_outs"
                    role="tabpanel"
                    aria-labelledby="dashboard-work-tab-move_outs"
                >
                    <WorkspacePanel
                    ...
                    >
                        <DashboardRecordList
                            ...
                            rows={props.moveOutQueue.items.map((moveOut) => ({
                                ...
                                value: t(
                                    `lease_move_outs.state_${moveOut.state}`,
                                ),
                                tone:
                                    moveOut.state === 'ready'
                                        ? 'success'
