...
import { LeaseFormGuide } from './lease-form-guide';
import { LeaseFormSection } from './lease-form-section';
import type { LeaseFormPage } from './types';

export function LeaseFormWorkspace({ page }: { page: LeaseFormPage }) {
    const form = useForm(page.initialValues);
    const groups = groupResourceFields(page.fields);
    const { t, text } = useTranslator();
    const formId = 'pmc-lease-form';
    ...
    return (
        <div className="pmc-lease-form-page">
            <ResourceHeader
                eyebrow={t('leases.form_eyebrow')}
                title={page.title}
            ...
            />
            <section className="pmc-lease-form-layout">
                <form id={formId} onSubmit={submit}>
                    ...
                    <div className="pmc-lease-mobile-actions">
                ...
                <LeaseFormGuide fields={page.fields} values={form.data} />
            </section>
        </div>
    );
}
