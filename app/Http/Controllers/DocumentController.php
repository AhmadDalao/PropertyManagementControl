...
class DocumentController extends Controller
{
    ...
    private function documentFormPage(User $actor, ?Document $document = null): array
    {
        ...
        $fields = [
            ...
            ['name' => 'type', 'label' => 'Document type', 'type' => 'select', 'required' => true, 'options' => $this->fieldOptions([
                'lease_contract',
                'signed_contract',
                'receipt',
                'owner_report',
        ...
        return [
            ...
            'initialValues' => [
                ...
                'type' => (string) request('type', $document?->type ?? 'signed_contract'),
                'title_en' => (string) request('title_en', $document?->title_en ?? ''),
                'title_ar' => (string) request('title_ar', $document?->title_ar ?? ''),
