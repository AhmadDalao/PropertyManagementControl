...
class AuditSubjectRegistry
{
    ...
    public function url(?Model $subject, ?string $type): ?string
    {
        ...
        return match ($alias) {
            ...
            'lease_move_out' => $this->relatedRoute('leases.show', 'lease', $subject->getAttribute('lease_id')),
            'collection_follow_up' => $this->relatedRoute(
                'rent-collection.follow-up',
                'leaseInstallment',
                $subject->getAttribute('lease_installment_id'),
            ),
            ...
            'maintenance_vendor' => route('maintenance-vendors.show', $subject),
            'maintenance_work_order' => route('maintenance-work-orders.show', $subject),
